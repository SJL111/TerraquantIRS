...
COMPANY_PATTERNS: list[tuple[str, str, str]] = [
    ...
    (r"Tower Semiconductor|TowerJazz|\bTSEM\b",                  "TSEM",      "upstream"),
    ...
    (r"MKS Instruments|MKS Inc|\bMKSI\b",                        "MKSI",      "upstream_t2"),
    (r"Keysight Technologies|Keysight\b|\bKEYS\b",               "KEYS",      "upstream_t2"),
    (r"Teradyne|\bTER\b",                                        "TER",       "upstream_t2"),
    (r"Onto Innovation|\bONTO\b",                                "ONTO",      "upstream_t2"),
    (r"FormFactor|\bFORM\b",                                     "FORM",      "upstream_t2"),
    ...
    (r"SiTime|\bSITM\b",                                         "SITM",      "upstream"),
    (r"Analog Devices|\bADI\b",                                  "ADI",       "upstream"),
    (r"Texas Instruments|\bTXN\b",                               "TXN",       "upstream"),
    (r"Microchip Technology|Microchip\b|\bMCHP\b",               "MCHP",      "upstream"),
    (r"ON Semiconductor|onsemi\b",                               "ON",        "upstream"),
    (r"Monolithic Power Systems|\bMPWR\b",                       "MPWR",      "upstream"),
    (r"STMicroelectronics|\bSTM\b",                              "STM",       "upstream"),
    (r"Corning\b|\bGLW\b",                                       "GLW",       "upstream"),
    (r"MACOM Technology|MACOM\b|\bMTSI\b",                        "MTSI",      "upstream"),
    (r"Fabrinet",                                                "FN",        "upstream"),
    (r"Coherent Corp|\bCOHR\b",                                  "COHR",      "upstream"),
    (r"Applied Optoelectronics|\bAAOI\b",                        "AAOI",      "upstream"),
    (r"Lumentum|\bLITE\b",                                       "LITE",      "upstream"),
    (r"Astera Labs|\bALAB\b",                                    "ALAB",      "upstream"),
    (r"MaxLinear|\bMXL\b",                                       "MXL",       "upstream"),
    (r"Credo Technology|\bCRDO\b",                               "CRDO",      "upstream"),
    (r"Amphenol|\bAPH\b",                                        "APH",       "upstream"),
    (r"Viavi Solutions|\bVIAV\b",                                "VIAV",      "upstream_t2"),
    (r"Ciena|\bCIEN\b",                                          "CIEN",      "downstream"),
    (r"Nokia\b|\bNOK\b",                                         "NOK",       "downstream"),
    ...
    (r"Broadcom|\bAVGO\b",                                       "AVGO",      "peer"),
    (r"Marvell Technology|Marvell\b|\bMRVL\b",                   "MRVL",      "peer"),
